...
import { X, Settings, Bell, Shield, Cloud } from 'lucide-react';
...
export const SettingsModal = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-md">
      <div className="glass-modal w-full max-w-lg rounded-3xl p-6 md:p-8 border border-white/20 shadow-2xl relative bg-slate-950/95 text-white space-y-6">
        <button
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <h2 className="text-2xl font-extrabold text-white">Session Reminder Timings</h2>
          </div>
        </div>
