...
import { Plus, Trash2, Moon, Target } from 'lucide-react';
...
export function PlannerPage() {
  ...
  const selectClass =
    'bg-card border border-border rounded-lg px-2.5 py-2 text-xs text-foreground focus:outline-none focus:ring-2 focus:ring-primary/20 min-h-11';
    ...
    <div className="space-y-6 pb-4 font-body">
      <header className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Plan tomorrow’s goal and session tasks.</p>
        </div>
      </header>
      ...
      <form onSubmit={handleSubmit} className="bg-card border border-border rounded-2xl p-5 md:p-6 space-y-6 shadow-sm">
